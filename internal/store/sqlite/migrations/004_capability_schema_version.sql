...
ALTER TABLE capabilities ADD COLUMN input_schema_version  TEXT NOT NULL DEFAULT '1';
ALTER TABLE capabilities ADD COLUMN output_schema_version TEXT NOT NULL DEFAULT '1';
